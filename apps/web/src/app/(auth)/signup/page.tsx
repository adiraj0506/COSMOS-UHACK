...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      sessionStorage.setItem("cosmos_email", form.email);
      sessionStorage.setItem("cosmos_role", data.role ?? form.role);
      if (data.fullName) {
        sessionStorage.setItem("cosmos_name", data.fullName);
      }
      if (data.companyName || form.companyName) {
        sessionStorage.setItem("cosmos_org", data.companyName ?? form.companyName);
      }
      if (data.collegeName || form.collegeName) {
        sessionStorage.setItem("cosmos_org", data.collegeName ?? form.collegeName);
      }
      if (data.city || form.city) {
        sessionStorage.setItem("cosmos_city", data.city ?? form.city);
      }
