...
export const MOCK_OPPORTUNITIES: Opportunity[] = [
  {
    ...
    deadline: '2025-05-15', posted: '1d ago', match: 91,
    // Razorpay careers — Engineering roles listing
    applyUrl: 'https://razorpay.com/jobs/#engineering',
  },
  {
    ...
    deadline: '2025-04-25', posted: '2d ago', match: 87,
    // Zepto careers page
  ...
  },
  {
    ...
    deadline: '2025-04-30', posted: '3d ago', match: 82, prize: '₹25,00,000',
    // Google for India Developers programme / Devfest registrations
  ...
  },
  {
    ...
    deadline: '2025-05-20', posted: '4d ago', match: 74,
    // CRED careers — Engineering
  ...
  },
  {
    ...
    deadline: '2025-06-01', posted: '5d ago', match: 68,
    // React India official website
    applyUrl: 'https://www.reactindia.io',
  },
  {
    ...
    deadline: '2025-12-31', posted: '1w ago', match: 79,
    // Appwrite SDK for Node.js GitHub repo — good-first-issue list
    applyUrl: 'https://github.com/appwrite/sdk-for-node/issues?q=is%3Aopen+label%3A%22good+first+issue%22',
  },
  {
    ...
    deadline: '2025-04-18', posted: '6d ago', match: 71,
    // Swiggy careers — internship listings
  ...
  },
  {
    ...
    deadline: '2025-05-05', posted: '1w ago', match: 65, prize: '$10,000',
    // HackMIT official site
  ...
  },
  {
    ...
    deadline: '2025-05-10', posted: '2d ago', match: 83,
    // Groww careers page
...
export const MOCK_COURSES: YTCourse[] = [
  ...
  },
  {
    ...
    tag: 'System Design', tagColor: '#a855f7',
  ...
  },
  {
    ...
    tag: 'PostgreSQL', tagColor: '#06b6d4',
  ...
  },
  {
    ...
    tag: 'System Design', tagColor: '#6366f1',
    url: 'https://www.youtube.com/watch?v=PdtlXdse7pw',
  },
  {
    id: 'c7', domain: 'ML/AI',
  ...
  },
  {
    ...
    tag: 'Graphs', tagColor: '#f59e0b',
    url: 'https://www.youtube.com/watch?v=0EgroneFh9M',
  },
]
